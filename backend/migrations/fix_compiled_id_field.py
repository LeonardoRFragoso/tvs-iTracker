"""
Script de migração manual para corrigir o valor 'compiled-f3106059-88eb-4242-a750-47451b7dc04a'
que está causando erro de conversão de data
"""
import sys
import os
...
def run_migration():
    """Corrige o valor 'compiled-f3106059-88eb-4242-a750-47451b7dc04a' que está causando erro"""
    try:
        changes_made = False
        ...
        for table in tables:
            ...
            for column in column_names:
                ...
                result = db.session.execute(text(f"""
                    ...
                    WHERE {column} = 'compiled-f3106059-88eb-4242-a750-47451b7dc04a'
                    OR {column} LIKE '%compiled-f3106059-88eb-4242-a750-47451b7dc04a%'
                """)).scalar()
        ...
        try:
            db.session.execute(text("""
                UPDATE players 
                SET last_ping = NULL 
                WHERE last_ping = 'compiled-f3106059-88eb-4242-a750-47451b7dc04a'
                OR last_ping LIKE '%compiled-f3106059-88eb-4242-a750-47451b7dc04a%'
            """))
            db.session.execute(text("""
                UPDATE players 
                SET last_content_sync = NULL 
                WHERE last_content_sync = 'compiled-f3106059-88eb-4242-a750-47451b7dc04a'
                OR last_content_sync LIKE '%compiled-f3106059-88eb-4242-a750-47451b7dc04a%'
            """))
